// src/pages/dashboard/EquipmentTable.tsx
                ...
                equipData.map((e) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="text-gray-600">{e.line}</TableCell>
                      ...
                      <TableCell>
                        ...
                        >
                          ...
                          />
                          <span
                            className={`text-xs font-bold ${currentStatus.textColor} text-gray-800 whitespace-nowrap`}
                          >
                            {currentStatus.text}
                          </span>
                        </div>
